...
SET src=d:\Projects\Jocys.com\WoW\TextToSpeech\WoW\JocysCom-TextToSpeech-WoW
SET dst=d:\Program Files\World of Warcraft\Interface\AddOns\JocysCom-TextToSpeech-WoW
