...
namespace JocysCom.TextToSpeech.Monitor
{
    ...
    public static class Crc32
    {
        ...
        public static uint ComputeHash(uint crc32, byte[] buffer, int offset, int length)
        {
            crc32 ^= uint.MaxValue;
            while (--length >= 0)
            {
        ...
        {
            return ComputeHash(0, buffer, offset, length);
        }

        /// <summary>
        /// Compute hash using UTF-8 string.
        /// </summary>
        public static uint ComputeHash(string s)
        {
            var buffer = System.Text.Encoding.UTF8.GetBytes(s);
            return ComputeHash(0, buffer, 0, buffer.Length);
        }
    }
}
