                    ...
                    _ = ControlsHelper.BeginInvoke(() =>
                    {
                        lock (threadIsRunningLock)
                        {
                            ...
                            if (!threadIsRunning)
                            {
                                ...
                                // Queue the ProcessPlayItems method for execution in the thread pool
                                _ = Task.Run(() => ProcessPlayItems(null))
                                .ContinueWith(t =>
                                {
                                    if (t.IsFaulted)
                                    {
                                    ...
                                    {
                                        Console.WriteLine("ProcessPlayItems completed successfully.");
                                    }
