...
How it works: When you open window with text (dialogue, quest, book, etc.) or receive chat message in game, <b>“WoW Addon”</b> sends whisper (chat) message between  <code>&lt;message&gt;...&lt;/message&gt;</code> tags to yourself. This message can include <code>text</code>, <code>name</code>, <code>gender</code>, <code>pitch</code>, <code>rate</code>, <code>effect</code>, <code>volume</code> and other values. Then, <b>“Monitor”</b>, <i>which must be running in background, while gaming,</i> picks-up this text between <code>&lt;message&gt;...&lt;/message&gt;</code> tags from your local network, formats it to SAPI XML and reads with specific text-to-speech voice.<br />
