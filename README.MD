...
<img align="left" src="http://www.jocys.com/TTS/Images/JocysCom_TTS_Monitor_Display_2x.png" /> <img align="left" src="http://www.jocys.com/TTS/Images/JocysCom_TTS_Monitor_Display_Small.png" />
...
<p style="color: #84e68c; text-align: justify;">Step 3: <span class="white">"TTS Monitor"</span> will capture this line of coloured pixels and convert it back to the text message if “Monitor: Display” capturin mode is enabled. Then, “Monitor”, <em>which must be running in the background</em>, converts it to SAPI XML and reads it with specific text-to-speech voice.</p>
