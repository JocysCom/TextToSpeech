...
<p style="text-align: center;">Old “Monitor” and “WoW Addon” versions. To extract WoW ( <u>Version</u> / <u>Interface</u> ) paste in chat: <i>/run print((select(4, GetBuildInfo())));</i></p>
