...
<li>"WoW Addon" converts text message to line of coloured pixels and shows this line inside your in-game window. For example: 1 RGB pixel can hold 3 bytes or 3 ASCII characters or 1 Japanese character (UTF-8). Default line's position is Top(0) Left(0):<br />
