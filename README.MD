### WoW version 8.x require new version of Addon and Monitor, which are using new message sending and capturing technique by using color pixels of the display. This addon is also works with official WoW Classic.
