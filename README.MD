...
<blockquote>
<sub>If “Social-Friends” button is not visible, change: <code>parent="FriendsMicroButton"</code> to <code>parent="UIParent"</code> in JocysCom-TextToSpeech-WoW.xml file.</sub>
</blockquote>
