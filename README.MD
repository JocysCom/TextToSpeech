 ...
 * <a target="_blank" href="http://www.jocys.com">Jocys.com</a> Text to Speech "World of Warcraft" Addon 8.2.5.4 (2019-10-10)
...
<li>"TTS Monitor" captures this line of coloured pixels and converts back to the text message if "Monitor: Display" capturing mode is enabled. Then, "TTS Monitor", <em>which must be running in the background</em>, converts it to SAPI XML and reads it with specific text-to-speech voice.</li>
</ol>
