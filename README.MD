...
<p>When you open in-game window with text (dialogue, quest, book, etc.) or receive chat message in game, “WoW Addon” creates message between <message><part>text</part></message> tags. This message can include <code>text</code>, <code>name</code>, <code>gender</code>, <code>effect</code>, <code>group</code>, <code>pitch</code>, <code>rate</code>, <code>volume</code>, etc. and <code>command</code> value. If “Monitor: Display” (default) capture method is enabled, “WoW Addon” converts message into line of coloured pixels and shows it on your display. Then, “Monitor”, which must be running in the background, picks-up this message from your display, converts it to SAPI XML and reads it with specific text-to-speech voice.</p>
 ...
 * <a href="/Files/Software/JocysCom-TextToSpeech-WoW-2019-06-26.zip">2019-06-26 (80200 / 8.2.0)</a><br /> 
 * <a href="/Files/Software/JocysCom-TextToSpeech-WoW-2018-09-24.zip">2018-09-24 (80000 / 8.0.1)</a><br /> 
...
<p>Additional text-to-speech voices must be visible in <b>“JocysCom.TextToSpeech.Monitor.exe”</b>.</p>
...
<blockquote>
<p align="justify"><sub>You can pin “Monitor” to Windows OS taskbar, if you plan to use it frequently. Official JocysCom.TextToSpeech.Monitor.exe is always <i>digitally signed</i>. Any modification in code of software, after it is signed, <i>invalidates</i> digital signature. <i>Digitally signed software</i> ensures that users can verify origin of software and that no one has tampered with it.</sub></p>
</blockquote>
...
<p>7. When <b>“Monitor”</b>, will open, setup voices in <b>[Voices]</b> tab (example).</p>
...
### 8. Run “World of Warcraft” game.
<hr />


<p>9. <b>[■]</b> (Stop text-to-speech) button will appear at the <b>center of the screen</b>. If you will move mouse pointer over <b>[≡]</b> (Options) button, menu with various <b>check-boxes</b> will appear. Move mouse pointer over any <strong>check-box</strong> and title will show, what it enables/disables.</p>
...
10. <b>[■]</b> (Stop) and <b>[►]</b> (Play) buttons will appear at the bottom of some windows too.</p>
