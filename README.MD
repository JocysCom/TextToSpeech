## Note: New version of WoW require new version of WoW Addon and Montor, which are using new message sending and capturing technique by using color pixels of the display.
